...
public class TopupVcoinActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try{
			setContentView(R.layout.topup_vcoin);
			...
			btnOrder.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					try {
						...
						if (Util.checkInternet(TopupVcoinActivity.this)) {
	...
	final Handler handlerOrder = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if(state==OrderState.Error) {
				AlertDialog.Builder builder = new AlertDialog.Builder(TopupVcoinActivity.this);
				...
				builder.setMessage(getString(R.string.txt_mycart_confirm_payment_msg))
						...
						.setPositiveButton(getString(R.string.text_ok),
								new DialogInterface.OnClickListener() {
									@Override
									public void onClick(DialogInterface dialog, int id) {
										Intent intent = new Intent(TopupVcoinActivity.this, EventMenuActivity.class);
										TopupVcoinActivity.this.startActivity(intent);
										TopupVcoinActivity.this.finish();
									}
								});
				AlertDialog alert = builder.create();
				alert.show();
	...
	private OrderState doOrder() throws Exception{
		...
		OrderData state = OrderController.createOrder(3, amount, getString(R.string.const_topup_vcoin_serviceid), account, true);
		if(state != null){
