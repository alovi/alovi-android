	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try{
			...
			for (int i = 0; i < pics.length; i++) {
				Integer pic = pics[i];
				ImageView img = new ImageView(MyCardActivity.this);
			...
			gallery.setOnItemSelectedListener(new OnItemSelectedListener() {
				...
				public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
					imageViews.get(arg2).setAnimation(AnimationUtils.loadAnimation(MyCardActivity.this, R.anim.item_grow));
					for (int i = 0; i < imageViews.size(); i++) {
						if (i != arg2) {
							imageViews.get(i).setAnimation(AnimationUtils.loadAnimation(MyCardActivity.this, R.anim.item_shrink));
						}
					}
				}
				@Override
			...
			btnOrder.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					try {
						...
						if (Util.checkInternet(MyCardActivity.this)) {
				...
				builder.setMessage(getString(R.string.txt_mycart_confirm_payment_msg))
						...
						.setPositiveButton(getString(R.string.text_ok),
								new DialogInterface.OnClickListener() {
									@Override
									public void onClick(DialogInterface dialog, int id) {
										Intent intent = new Intent(MyCardActivity.this, EventMenuActivity.class);
