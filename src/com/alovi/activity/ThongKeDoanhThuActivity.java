...
public class ThongKeDoanhThuActivity extends BaseActivity {
	...
	public void setControls() {
		...
		btnSave.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				try {
					if (Util.checkInternet(ThongKeDoanhThuActivity.this)) {
						...
						new Thread(new Runnable() {
							...
							public void run() {
								...
								if(newPassword.isEmpty()) {
									Util.showDialog(ThongKeDoanhThuActivity.this,getString(R.string.txt_warning), getString(R.string.msg_changepassword_null));
									return;
								}
	...
	final Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {			
			...
			if(res.equals("success")) {//ChangePassErrorState.Success.name())){
