...
public class MyAsiaTopupActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try{
			setContentView(R.layout.asia_topup);
			...
			btnOrder.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					try {
						...
						if (Util.checkInternet(MyAsiaTopupActivity.this)) {
	...
	final Handler handlerOrder = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if(state==OrderState.Error) {
				AlertDialog.Builder builder = new AlertDialog.Builder(MyAsiaTopupActivity.this);
				...
				builder.setMessage(getString(R.string.txt_mycart_confirm_payment_msg))
						...
						.setPositiveButton(getString(R.string.text_ok),
								new DialogInterface.OnClickListener() {
									@Override
									public void onClick(DialogInterface dialog, int id) {
										Intent intent = new Intent(MyAsiaTopupActivity.this, EventMenuActivity.class);
										MyAsiaTopupActivity.this.startActivity(intent);
										MyAsiaTopupActivity.this.finish();
									}
								});
				AlertDialog alert = builder.create();
				alert.show();
