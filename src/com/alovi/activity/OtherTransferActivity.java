...
public class OtherTransferActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.othertransfer);
	...
	public void setControls() {
		...
		btnSave.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				try {
					if (Util.checkInternet(OtherTransferActivity.this)) {
						...
						new Thread(new Runnable() {
							...
							public void run() {
								...
								if(newPassword.isEmpty()) {
									Util.showDialog(OtherTransferActivity.this,getString(R.string.txt_warning), getString(R.string.msg_changepassword_null));
									return;
								}
