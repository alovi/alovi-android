...
public class MyZingXuCardActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try{
			setContentView(R.layout.zingxu_card_code);
			menu = new MainMenu(this, true);
			menu.setTextMainTitle(getString(R.string.txt_zingxu_card_title).toString());
			...
			txtServiceId.setText(R.string.txt_zingxu_card);
			...
			btnOrder.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					try {
						...
						if (Util.checkInternet(MyZingXuCardActivity.this)) {
	...
	final Handler handlerOrder = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if(state==OrderState.Error) {
				AlertDialog.Builder builder = new AlertDialog.Builder(MyZingXuCardActivity.this);
				...
				builder.setMessage(getString(R.string.txt_mycart_confirm_payment_msg))
						...
						.setPositiveButton(getString(R.string.text_ok),
								new DialogInterface.OnClickListener() {
									@Override
									public void onClick(DialogInterface dialog, int id) {
										Intent intent = new Intent(MyZingXuCardActivity.this, EventMenuActivity.class);
										MyZingXuCardActivity.this.startActivity(intent);
										MyZingXuCardActivity.this.finish();
									}
								});
				AlertDialog alert = builder.create();
				alert.show();
	...
	private OrderState doOrder() throws Exception{
		...
		state = OrderController.createOrder(2, amount, getString(R.string.const_card_zingxu_serviceid), null, true);
		if(state != null){
